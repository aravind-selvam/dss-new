...
from common.util import nearest_valid_size, negative_sampling, pad_if_needed, random_crop


###################
# Label
###################
def get_detr_label(this_event_df, duration, start, end, max_det: int = 20):
