...
from common.util import gaussian_label, nearest_valid_size, negative_sampling, random_crop

def get_seg_label(this_event_df, num_frames, duration, start, end):
...
class SegValidDataset(Dataset):
    def __init__(self, cfg, chunk_features, event_df: pl.DataFrame):
        self.cfg = cfg
